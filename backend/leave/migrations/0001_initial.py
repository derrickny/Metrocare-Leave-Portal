# Generated by Django 4.2.6 on 2024-05-03 21:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('EMP', 'Employee'), ('MGR', 'Manager'), ('HR', 'HR'), ('ADM', 'Admin')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hr_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hr_approvals', to=settings.AUTH_USER_MODEL)),
                ('leave_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='leave.leavetype')),
                ('manager_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='manager_approvals', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='user',
            name='branch',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='leave.branch'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='managers', to='leave.branch'),
        ),
        migrations.AddField(
            model_name='user',
